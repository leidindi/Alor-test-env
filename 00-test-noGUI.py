...
def main():
    ...
    TObj.create_battery(attribute1="vision",attribute2="CP1223 FR",attribute3="LED-ACID")
    TObj.set_battery(attribute1="vision",attribute2="CP1223 FR",attribute3="LED-ACID")
    ...
    data = TObj.run("charging", Charge_Volt_start=Base, Charge_volt_end=16,
                    ...
                    Slew_volt=0.005, Slew_current=0.005,
                    LeadinTime=5, Charge_time=240, c_rate=0.12,
                    DCharge_time=50, numCycles=cycles, Goal_voltage=goal,Charge_routine=[["CV",30],["CC",30],["CV",30],["CC",30],["CV",30],["CC",30]])
